...
class FinancialLedger(Base):
    ...
    booking_id: Mapped[uuid.UUID] = mapped_column(UUID(as_uuid=True), ForeignKey("bookings.id", ondelete="CASCADE"), unique=True, nullable=False, index=True)
    ...
    payment_status: Mapped[PaymentStatus] = mapped_column(
        ...
        nullable=False, default=PaymentStatus.UNPAID, index=True,
    )
    ...
    booking: Mapped["Booking"] = relationship("Booking", back_populates="ledger", lazy="noload")